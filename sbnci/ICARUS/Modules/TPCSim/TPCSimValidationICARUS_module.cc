////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Class:       TPCSimValidationICARUS                                                                             //
// Modlue Type: Analyser                                                                                  //
// File         TPCSimValidationICARUS_module.cc                                                                //
...
class ana::TPCSimValidationICARUS : public art::EDAnalyzer {
  public:

    explicit TPCSimValidationICARUS(const fhicl::ParameterSet& pset);
    // The compiler-generated destructor is fine for non-base
    // classes without bare pointers or other resource use.

    // Plugins should not be copied or assigned.
    TPCSimValidationICARUS(TPCSimValidationICARUS const&) = delete;
    TPCSimValidationICARUS(TPCSimValidationICARUS&&) = delete;
    TPCSimValidationICARUS& operator=(TPCSimValidationICARUS const&) = delete;
    TPCSimValidationICARUS& operator=(TPCSimValidationICARUS&&) = delete;
...
//////////////////////////////////////////////////////////////////////////////////////
ana::TPCSimValidationICARUS::TPCSimValidationICARUS(const fhicl::ParameterSet& pset) : 
  EDAnalyzer(pset),
  numevents(0)
{
  ...
  fRawDigitLabelVect = pset.get<std::vector<art::InputTag>>("RawDigitLabel",std::vector<art::InputTag>()={"daq:PHYSCRATEDATA"});
  fVerbose             = pset.get<bool>("Verbose",false); 

} //end constructor

///////////////////////////////////////////////////////////////////////////////
void ana::TPCSimValidationICARUS::beginJob() {
...
////////////////////////////////////////////////////////////////////
void ana::TPCSimValidationICARUS::analyze(const art::Event& evt) {

  fRun    = evt.run();
  fSubRun = evt.subRun();
  fEvent  = evt.event();
cout<<"analyzerStarted"<<endl;
  if(fVerbose) {
 ...
 art::Handle< vector<raw::RawDigit> > RawDigitListHandle;
  ...
  fNRawDigits = RawDigitList.size();
	std::cout<<rawDigitLabel <<std::endl;
  for(auto const& digit : RawDigitList) {
//	std::cout<<"NADC="<<digit->NADC()<<std::endl;
...
//////////////////////////////////////////////////////////////////////////
void ana::TPCSimValidationICARUS::endJob() {
...
DEFINE_ART_MODULE(ana::TPCSimValidationICARUS)
