...
void sbnciplot_recoeff_nue(TString inputFileName)
{
  ...
  //Electron Plots
  Plot(tree,outputFile,directoryName,"11","mc_theta_xz",30,-180,180,";True #theta_{xz} (#circ);Fraction;");
  Plot(tree,outputFile,directoryName,"11","mc_theta_yz",30,-180,180,";True #theta_{yz} (#circ);Fraction;");
  Plot(tree,outputFile,directoryName,"11","mc_theta_xy",30,-180,180,";True #theta_{xy} (#circ);Fraction;");
  Plot(tree,outputFile,directoryName,"11","mc_momentum",50,0,2,";True p (GeV/c);Fraction;");
  Plot(tree,outputFile,directoryName,"11","mc_energy0",50,0,2,";True E (GeV);Fraction;");

  //Electron High Quality Plots
  Plot(tree,outputFile,directoryName,"11","mc_theta_xz",30,-180,180,";True #theta_{xz} (#circ);Fraction;",true);
  Plot(tree,outputFile,directoryName,"11","mc_theta_yz",30,-180,180,";True #theta_{yz} (#circ);Fraction;",true);
  Plot(tree,outputFile,directoryName,"11","mc_theta_xy",30,-180,180,";True #theta_{xy} (#circ);Fraction;",true);
  Plot(tree,outputFile,directoryName,"11","mc_momentum",50,0,2,";True p (GeV/c);Fraction;",true);
  Plot(tree,outputFile,directoryName,"11","mc_energy0",50,0,2,";True E (GeV);Fraction;",true);
