...
export ref_ana_hist=${ref_pdsrecovalidation_hist}
export normalise_plots=${normalise_plots_pdsrecovalidation}

## Name of plotting script. This should be the only line that needs changing for other CI chains.
plotScript="${expCIDir}/scripts/sbnciplot_pdsrecovalidation_${expName}.C"
