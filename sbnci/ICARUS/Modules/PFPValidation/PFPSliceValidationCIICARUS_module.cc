////////////////////////////////////////////////////////////////////////////////
// Class:       PFPSliceValidationCIICARUS                                          //
// Plugin Type: analyzer (art v3_02_06)                                       //
// File:        PFPSliceValidationCIICARUS_module.cc                                //
//                                                                            //
...
class sbnci::PFPSliceValidationCIICARUS : public art::EDAnalyzer {
  public:
  explicit PFPSliceValidationCIICARUS(fhicl::ParameterSet const& pset);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  PFPSliceValidationCIICARUS(PFPSliceValidationCIICARUS const&) = delete;
  PFPSliceValidationCIICARUS(PFPSliceValidationCIICARUS&&) = delete;
  PFPSliceValidationCIICARUS& operator=(PFPSliceValidationCIICARUS const&) = delete;
  PFPSliceValidationCIICARUS& operator=(PFPSliceValidationCIICARUS&&) = delete;
...
sbnci::PFPSliceValidationCIICARUS::PFPSliceValidationCIICARUS(fhicl::ParameterSet const& pset)
    : EDAnalyzer { pset }
...
void sbnci::PFPSliceValidationCIICARUS::beginJob()
{
...
void sbnci::PFPSliceValidationCIICARUS::analyze(art::Event const& evt)
{
  ClearEventTree();
...
std::map<art::Ptr<simb::MCTruth>, int> sbnci::PFPSliceValidationCIICARUS::GetTruthHitMap(
...
art::Ptr<simb::MCTruth> sbnci::PFPSliceValidationCIICARUS::GetSliceTruthMatchHits(
...
void sbnci::PFPSliceValidationCIICARUS::ClearTrueTree()
{
...
void sbnci::PFPSliceValidationCIICARUS::ClearEventTree()
{
...
template <class T>
void sbnci::PFPSliceValidationCIICARUS::initTree(TTree* Tree,
    const std::string& branchName,
    std::map<std::string, T>& Metric,
...
DEFINE_ART_MODULE(sbnci::PFPSliceValidationCIICARUS)
