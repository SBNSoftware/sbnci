////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Class:       PDSValidationICARUS                                                                             //
// Modlue Type: Analyser                                                                                  //
// File         PDSValidationICARUS_module.cc                                                                //
...
class ana::PDSValidationICARUS : public art::EDAnalyzer {
  public:

    explicit PDSValidationICARUS(const fhicl::ParameterSet& pset);
    // The compiler-generated destructor is fine for non-base
    // classes without bare pointers or other resource use.

    // Plugins should not be copied or assigned.
    PDSValidationICARUS(PDSValidationICARUS const&) = delete;
    PDSValidationICARUS(PDSValidationICARUS&&) = delete;
    PDSValidationICARUS& operator=(PDSValidationICARUS const&) = delete;
    PDSValidationICARUS& operator=(PDSValidationICARUS&&) = delete;
...
//////////////////////////////////////////////////////////////////////////////////////
ana::PDSValidationICARUS::PDSValidationICARUS(const fhicl::ParameterSet& pset) : 
  EDAnalyzer(pset),
  numevents(0)
{
...
///////////////////////////////////////////////////////////////////////////////
void ana::PDSValidationICARUS::beginJob() {
...
////////////////////////////////////////////////////////////////////
void ana::PDSValidationICARUS::analyze(const art::Event& evt) {
...
//////////////////////////////////////////////////////////////////////////
void ana::PDSValidationICARUS::endJob() {
...
DEFINE_ART_MODULE(ana::PDSValidationICARUS)
